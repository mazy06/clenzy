...
/**
 * Adaptation locale : la sidebar bascule en feuille latérale sous `lg` (1024)
 * et non sous `md` (768). Un rail d'icônes sur tablette reposerait entièrement
 * sur des infobulles au survol, qui n'existent pas sur écran tactile.
...
function SidebarProvider({
  ...
  const isMobile = useIsMobile(SIDEBAR_SHEET_BREAKPOINT)
