...
export function usePropertyForm({
  ...
  useEffect(() => {
    ...
    reset({
      ...
      country: p.country || '',
      countryCode: ((p as { countryCode?: string }).countryCode) || 'FR',
      timezone: ((p as { timezone?: string }).timezone) || 'Europe/Paris',
      defaultCleaningType: ((p as { defaultCleaningType?: 'CLEANING' | 'EXPRESS_CLEANING' | 'DEEP_CLEANING' }).defaultCleaningType) || 'CLEANING',
      ...
      orgCanCreateVouchers: p.orgCanCreateVouchers ?? false,
      // Geolocalisation
  ...
  const mutation = useMutation({
    mutationFn: async (formData: PropertyFormValues) => {
      const backendData = {
        ...
        defaultCleaningType: formData.defaultCleaningType,
        type: formData.type,
        ...
        orgCanCreateVouchers: formData.orgCanCreateVouchers,
        // Geolocalisation
