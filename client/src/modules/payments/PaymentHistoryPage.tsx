...
import type { PaymentRecord, PaymentSummary } from '../../services/api/paymentsApi';
...
const PaymentHistoryPage: React.FC = () => {
  ...
  }, [page, rowsPerPage, statusFilter, dateFrom, dateTo, search]);
  ...
  const getStatusChip = (status: PaymentRecord['status']) => {
    const config: Record<PaymentRecord['status'], { color: 'success' | 'warning' | 'error' | 'info'; label: string }> = {
