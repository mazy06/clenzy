...
const PROVIDER_FIELDS: Record<PaymentProviderType, FieldSpec[]> = {
  ...
  YOUCAN_PAY: [
    {
      key: 'apiKey',
      label: 'Clé privée (pri_key)',
      type: 'password',
      required: true,
      goesInConfigJson: false,
      topLevelKey: 'apiKey',
      helper: 'Clé privée YouCan Pay (Dashboard → Settings → API Keys). Sert au tokenize et à la vérification des webhooks. Laissez vide pour ne pas modifier.',
    },
    {
      key: 'webhookSecret',
      label: 'Webhook Secret',
      ...
      goesInConfigJson: false,
      topLevelKey: 'webhookSecret',
      helper: 'Secret de signature HMAC-SHA256 dédié aux webhooks. Si vide, la clé privée sera utilisée comme fallback.',
    },
    {
      key: 'defaultSuccessUrl',
      label: 'URL de succès par défaut',
