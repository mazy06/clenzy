    ...
    <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2.5 }}>
      <Grid container spacing={2.5}>
        ...
        <Grid item xs={12} sm={6}>
          <SectionPaper icon={<SettingsIcon size={20} strokeWidth={1.75} />} titleKey="bookingEngine.sections.behavior">
        ...
        {/* Policies */}
        <Grid item xs={12} sm={6}>
          <SectionPaper icon={<Gavel size={20} strokeWidth={1.75} />} titleKey="bookingEngine.sections.policies">
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1.5 }}>
              <TextField
                fullWidth
                size="small"
        ...
        {/* Security */}
        <Grid item xs={12} sm={6}>
          <SectionPaper icon={<Security size={20} strokeWidth={1.75} />} titleKey="bookingEngine.sections.security">
            <TextField
              fullWidth
              size="small"
              multiline
        ...
        {/* Display Options */}
        <Grid item xs={12} sm={6}>
          <SectionPaper icon={<ToggleOn size={20} strokeWidth={1.75} />} titleKey="bookingEngine.sections.displayOptions">
      ...
      <SectionPaper icon={<Widgets size={20} strokeWidth={1.75} />} titleKey="bookingEngine.sections.componentVisibility">
