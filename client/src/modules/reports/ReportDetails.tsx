...
const PropertiesReport: React.FC = () => {
  ...
  return (
    <>
      ...
      {/* ─── Occupation & clientèle — Graphiques analytiques ─── */}
      ...
      {/* ─── Performance & outils — Classement et benchmark ─── */}
      ...
      {/* ─── Rapports API — Données opérationnelles ─── */}
      <Divider sx={{ my: 3 }} />
      <Typography variant="subtitle2" color="text.secondary" sx={{ mb: 2, fontWeight: 600, fontSize: '0.8125rem' }}>
        {t('reports.charts.operationalData', 'Données opérationnelles')}
      </Typography>
...
const FinancialReport: React.FC = () => {
  ...
  return (
    <>
      ...
      {/* ─── Revenue & tarifs — Graphiques analytiques ─── */}
