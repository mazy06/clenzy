...
CLENZY_V2 = {
    ...
    "02-booking-engine.csv": {
        ...
        "Builder drag-and-drop sans code": "2",
        "Templates de site pretes a l'emploi": "2",
        ...
        "Outils IA (contenu / SEO / design)": "2",
    },
...
def build_full():
    ...
    try:
        ...
        for t in ["<b>Finance &amp; Compta 2,2 -&gt; 2,5</b> : abstraction e-invoicing + 3 providers pays (Factur-X FR, DGI Maroc, "
                  ...
                  "<b>Channel Management 2,0 -&gt; 2,5</b> : sync 2-way (DLT/audit #7) + restrictions (min_stay_arrival + "
