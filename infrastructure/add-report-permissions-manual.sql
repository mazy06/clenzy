-- Script manuel pour ajouter les permissions supplémentaires pour les rapports
-- À exécuter si la migration V14 n'a pas encore été appliquée
-- Date: 2026-01-25
...
-- Vérification : afficher toutes les permissions reports
SELECT name, description, module FROM permissions WHERE name LIKE 'reports:%' ORDER BY name;
