...
# Script de démarrage détaché pour l'environnement de production Clenzy
echo "🚀 Démarrage de l'environnement de production Clenzy (mode détaché)..."
...
# Démarrer les services de production en mode détaché
echo "🔧 Démarrage des services de production (mode détaché)..."
...
echo "✅ Environnement de production démarré en mode détaché !"
