...
class WebSocketConfigTest {
    ...
    void whenRegisteringStompEndpoints_thenConfiguredOriginsApplied() {
        WebSocketConfig config = new WebSocketConfig(authInterceptor, new WebSocketCookieHandshakeInterceptor(), subscribeInterceptor,
        ...
        // L'enregistrement chaine desormais l'intercepteur de poignee de main,
        // qui recupere le jeton du cookie de session.
