...
@DisplayName("DocuSignOAuthController")
class DocuSignOAuthControllerTest {
    ...
    private DocuSignOAuthController controller;
    private Jwt jwt;

    @BeforeEach
    void setUp() {
        controller = new DocuSignOAuthController(oauthService, tenantContext);
    ...
    class Connect {
        ...
        void whenNotConnected_thenReturnsAuthorizationUrl() {
            ...
            assertThat(response.getBody())
                    ...
                    .containsEntry("authorization_url", "https://account.docusign.com/oauth/auth?state=xyz");
        }
    }
    ...
    class Status {
        ...
        @Test
        @DisplayName("when ACTIVE connection then returns connected true with accountId and scopes")
        void whenActiveConnection_thenReturnsConnectedTrue() {
            ...
            conn.setAccountId("acct-9999");
            conn.setScopes("signature impersonation");
            ...
            assertThat(body).containsEntry("accountId", "acct-9999");
            assertThat(body).containsEntry("scopes", "signature impersonation");
        ...
        @Test
        @DisplayName("when connection EXPIRED then returns connected false with status and errorMessage")
