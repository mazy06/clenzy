-- 0323 : Catalogue travaux enrichi et classé par domaine (label + domain portés
-- par la donnée, prix 0 € editables). Remplace UNIQUEMENT les configs non
-- personnalisees : vide, '[]', ou le seed par defaut a 6 types (0321). Ne touche
-- JAMAIS une grille dont les prix ont ete edites.
