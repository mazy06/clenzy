-- 0067: Ajouter les notification_key pour l'auto-assignation
-- Les nouvelles clés SERVICE_REQUEST_TEAM_ASSIGNED, SERVICE_REQUEST_NO_TEAM_AVAILABLE
-- et SERVICE_REQUEST_ESCALATION sont utilisées par le scheduler d'auto-assignation.
...
ALTER TABLE notifications ADD CONSTRAINT notifications_notification_key_check
    CHECK (notification_key IN (
        ...
        -- SERVICE_REQUEST (11 = 8 + 3 auto-assign)
