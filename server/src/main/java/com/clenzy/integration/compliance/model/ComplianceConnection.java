...
/**
 * Connexion API key vers un provider de conformite (declaration voyageurs).
 *
 * <p>Multi-tenant via filtre Hibernate. Une seule connexion par couple
 * (organization_id, provider_type).</p>
 */
@Entity
@Table(name = "compliance_connections",
    indexes = @Index(name = "idx_compliance_conn_org", columnList = "organization_id"))
@Filter(name = "organizationFilter", condition = "organization_id = :orgId")
public class ComplianceConnection {
    ...
    private ComplianceProviderType providerType;
    ...
    public ComplianceProviderType getProviderType() { return providerType; }
    public void setProviderType(ComplianceProviderType providerType) { this.providerType = providerType; }
