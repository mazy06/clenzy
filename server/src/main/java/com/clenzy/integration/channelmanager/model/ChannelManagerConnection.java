...
/**
 * Connexion API key vers un Channel Manager (middleware). Multi-tenant.
 * Une connexion par couple (organization_id, provider_type).
 */
@Entity
@Table(name = "channel_manager_connections",
    indexes = @Index(name = "idx_channel_mgr_conn_org", columnList = "organization_id"))
@Filter(name = "organizationFilter", condition = "organization_id = :orgId")
public class ChannelManagerConnection {
    ...
    private ChannelManagerProviderType providerType;
    ...
    public ChannelManagerProviderType getProviderType() { return providerType; }
    public void setProviderType(ChannelManagerProviderType providerType) { this.providerType = providerType; }
