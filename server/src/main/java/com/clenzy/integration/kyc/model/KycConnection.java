...
/**
 * Connexion API key vers un provider de KYC / verification d'identite.
 * Multi-tenant via filtre Hibernate. Une connexion par couple
 * (organization_id, provider_type).
 */
@Entity
@Table(name = "kyc_connections",
    indexes = @Index(name = "idx_kyc_conn_org", columnList = "organization_id"))
@Filter(name = "organizationFilter", condition = "organization_id = :orgId")
public class KycConnection {
    ...
    private KycProviderType providerType;
    ...
    public KycProviderType getProviderType() { return providerType; }
    public void setProviderType(KycProviderType providerType) { this.providerType = providerType; }
