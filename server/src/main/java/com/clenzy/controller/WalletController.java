...
public class WalletController {
     ...
     * La logique (transactionnelle) vit dans WalletService.initializeWallets.
     */
    ...
    public ResponseEntity<Map<String, Object>> initializeWallets() {
        ...
        WalletService.WalletInitializationResult result = walletService.initializeWallets(orgId);
