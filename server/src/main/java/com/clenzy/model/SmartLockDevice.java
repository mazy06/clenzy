...
@Table(name = "smart_lock_devices", indexes = {
    @Index(name = "idx_smart_lock_user_id", columnList = "user_id"),
    @Index(name = "idx_smart_lock_property_id", columnList = "property_id"),
    @Index(name = "idx_smart_lock_status", columnList = "status"),
    @Index(name = "idx_smart_lock_org_id", columnList = "organization_id")
})
