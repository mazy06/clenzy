...
public record SpecialistRequest(
    ...
    /** Helper sans orchestrationCtx ni parentTraceId (defaults vides). */
    public static SpecialistRequest of(String query, AgentContext context) {
        return new SpecialistRequest(query, context, OrchestrationContext.empty(), null);
    }

    /** Helper avec orchestrationCtx (cas standard quand AgentOrchestrator pre-charge). */
    public static SpecialistRequest of(String query, AgentContext context,
                                         OrchestrationContext orchestrationCtx) {
        return new SpecialistRequest(query, context, orchestrationCtx, null);
    }
}
