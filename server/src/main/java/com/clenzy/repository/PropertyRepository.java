...
public interface PropertyRepository extends JpaRepository<Property, Long>, JpaSpecificationExecutor<Property> {
    ...
    List<Property> findByOwnerKeycloakIdWithRelations(@Param("ownerKeycloakId") String ownerKeycloakId);
    ...
    List<Property> findWithManagersByOwnerKeycloakId(@Param("ownerKeycloakId") String ownerKeycloakId);
    
    /**
     * Requête pour compter les propriétés (sans charger les données)
     */
    @Query("SELECT COUNT(p) FROM Property p WHERE p.owner.keycloakId = :ownerKeycloakId")
    long countByOwnerKeycloakId(@Param("ownerKeycloakId") String ownerKeycloakId);
